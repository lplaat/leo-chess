...
{#if selector == 'w1'}
    <svg style="transform: scale({upscale});"  xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45">
...
{:else if selector == 'w6'}
    <svg style="transform: scale({upscale});"  xmlns="http://www.w3.org/2000/svg" width="45" height="45">
...
{:else if selector == 'b5'}
    <svg style="transform: scale({upscale});"  xmlns="http://www.w3.org/2000/svg" version="1.1" width="45"
    height="45">
